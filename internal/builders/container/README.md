...
provenance:
  ...
  uses: Kong/slsa-github-generator/.github/workflows/generator_container_slsa3.yml@v2_node20
  with:
...
about your use case on [issue #358](https://github.com/Kong/slsa-github-generator/issues/358). If
you have an issue in all other triggers please submit a [new
issue](https://github.com/Kong/slsa-github-generator/issues/new/choose).

### Workflow Inputs

The [container workflow](https://github.com/Kong/slsa-github-generator/blob/main/.github/workflows/generator_container_slsa3.yml) accepts the following inputs:
...
The [container workflow](https://github.com/Kong/slsa-github-generator/blob/main/.github/workflows/generator_container_slsa3.yml) accepts the following outputs:
...
| ---------------------------- | ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `buildType`                  | `"https://github.com/Kong/slsa-github-generator/container@v1"` | Identifies a the GitHub Actions build.                                                                                                                                                                                 |
...
```json
{
  ...
  "predicate": {
    "builder": {
      "id": "https://github.com/Kong/slsa-github-generator/.github/workflows/generator_container_slsa3.yml@refs/tags/v1.4.0"
    },
    "buildType": "https://github.com/Kong/slsa-github-generator/container@v1",
    "invocation": {
      "configSource": {
...
predicate: {
  ...
  // workflow.
  builder: {
    id: =~"^https://github.com/Kong/slsa-github-generator/.github/workflows/generator_container_slsa3.yml@refs/tags/v[0-9]+.[0-9]+.[0-9]+$"
  }
  invocation: {
    configSource: {
...
COSIGN_EXPERIMENTAL=1 cosign verify-attestation \
  ...
  --certificate-identity-regexp '^https://github.com/Kong/slsa-github-generator/.github/workflows/generator_container_slsa3.yml@refs/tags/v[0-9]+.[0-9]+.[0-9]+$' \
  --policy policy.cue \
...
Certificate subject:  https://github.com/Kong/slsa-github-generator/.github/workflows/generator_container_slsa3.yml@refs/tags/v1.4.0
      ...
      verifyImages:
        ...
        - imageReferences:
          ...
          attestors:
            ...
            - entries:
                - keyless:
                    subject: "https://github.com/Kong/slsa-github-generator/.github/workflows/generator_container_slsa3.yml@refs/tags/v1.4.0"
                    issuer: "https://token.actions.githubusercontent.com"
            ...
            - predicateType: https://slsa.dev/provenance/v0.2
              conditions:
                - all:
                    ...
                    # unmodified. It verifies that the builder is the container
                    # workflow.
                    - key: "{{ regex_match('^https://github.com/Kong/slsa-github-generator/.github/workflows/generator_container_slsa3.yml@refs/tags/v[0-9].[0-9].[0-9]$','{{ builder.id}}') }}"
                      operator: Equals
                      value: true
```
