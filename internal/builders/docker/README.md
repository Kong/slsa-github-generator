...
[beta testing](https://github.com/Kong/slsa-github-generator/milestone/4).
...
The [container-based
workflow](https://github.com/Kong/slsa-github-generator/blob/main/.github/workflows/builder_container-based_slsa3.yml)
...
jobs:
  ...
  build:
    ...
    needs: args
    uses: Kong/slsa-github-generator/.github/workflows/builder_container-based_slsa3.yml@v2_node20
    with:
      builder-image: "bash"
...
The [container-based
workflow](https://github.com/Kong/slsa-github-generator/blob/main/.github/workflows/builder_container-based_slsa3.yml) produces the following outputs:
...
```json
{
  ...
  "predicate": {
    ...
    "runDetails": {
      "builder": {
        "id": "https://github.com/Kong/slsa-github-generator/.github/workflows/builder_container-based_slsa3.yml@refs/tags/v1.5.0"
      },
      "metadata": {
...
go run *.go  dry-run \
  ...
  --source-repo git+https://github.com/Kong/slsa-github-generator \
