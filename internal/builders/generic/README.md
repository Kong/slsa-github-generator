...
provenance:
  ...
  uses: Kong/slsa-github-generator/.github/workflows/generator_generic_slsa3.yml@v2_node20
  with:
...
The you must then share this file with the generator using the [actions/generator/generic/create-base64-subjects-from-file Action](https://github.com/Kong/slsa-github-generator/tree/main/actions/generator/generic/create-base64-subjects-from-file):
...
build:
  ...
  ...
    uses: Kong/slsa-github-generator/actions/generator/generic/create-base64-subjects-from-file@v2_node20
    id: hashes
    with:
...
The [generic workflow](https://github.com/Kong/slsa-github-generator/blob/main/.github/workflows/generator_generic_slsa3.yml) accepts the following inputs:
...
The [generic workflow](https://github.com/Kong/slsa-github-generator/blob/main/.github/workflows/generator_generic_slsa3.yml) produces the following outputs:
...
| ---------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `buildType`                  | `"https://github.com/Kong/slsa-github-generator/generic@v1"` | Identifies a generic GitHub Actions build.                                                                                                                                                                             |
...
```json
{
  ...
  "predicate": {
    "builder": {
      "id": "https://github.com/Kong/slsa-github-generator/.github/workflows/generator_generic_slsa3.yml@refs/tags/v1.2.2"
    },
...
See issue
[#1702](https://github.com/Kong/slsa-github-generator/issues/1702) for
more details.
...
This issue is currently tracked by [issue #1163](https://github.com/Kong/slsa-github-generator/issues/1163)
