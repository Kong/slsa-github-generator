...
provenance:
  ...
  uses: Kong/slsa-github-generator/.github/workflows/generator_generic_slsa3.yml@v2.0.0
  with:
...
build:
  ...
  ...
    uses: Kong/slsa-github-generator/actions/generator/generic/create-base64-subjects-from-file@v2.0.0
    id: hashes
    with:
