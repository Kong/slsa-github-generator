...
[Node.js Builder GA milestone](https://github.com/Kong/slsa-github-generator/milestone/17).
...
jobs:
  build:
    ...
    uses: Kong/slsa-github-generator/.github/workflows/builder_nodejs_slsa3.yml@v2_node20
    with:
...
publish:
  ...
  steps:
    ...
    - name: publish
      id: publish
      uses: Kong/slsa-github-generator/actions/nodejs/publish@v2_node20
      with:
        access: public
  ...
  publish:
    ...
    steps:
      ...
      - name: Download tarball
        uses: Kong/slsa-github-generator/actions/nodejs/secure-package-download@v2_node20
        with:
      ...
      - name: Download provenance
        uses: Kong/slsa-github-generator/actions/nodejs/secure-attestations-download@v2_node20
        with:
...
| Name                         | Value                                                                                                                  | Description                                                                                                                                                                                                            |
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `builder.id`                 | `https://github.com/Kong/slsa-github-generator/.github/workflows/builder_nodejs_slsa3.yml@refs/tags/v1.5.0"` | Identifies the Node.js builder                                                                                                                                                                                         |
| `buildType`                  | `"https://github.com/Kong/slsa-github-generator/delegator-generic@v0"`                                       | Identifies a the GitHub Actions build.                                                                                                                                                                                 |
...
```json
{
  ...
  "predicate": {
    "builder": {
      "id": "https://github.com/Kong/slsa-github-generator/.github/workflows/builder_nodejs_slsa3.yml@refs/tags/v1.5.0"
    },
...
release. See
[#1789](https://github.com/Kong/slsa-github-generator/issues/1789) for
more details.
