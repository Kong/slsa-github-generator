...
Release [v1.10.0](https://github.com/Kong/slsa-github-generator/releases/tag/v1.10.0) includes bug fixes and new features.

See the [full change list](https://github.com/Kong/slsa-github-generator/compare/v1.9.0...v1.10.0).

### v1.10.0: TUF fix

- The cosign TUF roots were fixed (#3350). More details [here](https://github.com/Kong/slsa-github-generator/blob/v1.10.0/README.md#error-updating-to-tuf-remote-mirror-invalid).
...
See the [full change list](https://github.com/Kong/slsa-github-generator/compare/v1.8.0...v1.9.0).

### v1.9.0: BYOB framework (beta)

- **New**: A [new framework](https://github.com/Kong/slsa-github-generator/blob/main/BYOB.md) to turn GitHub Actions into SLSA compliant builders.

### v1.9.0: Maven builder (beta)

- **New**: A [Maven builder](https://github.com/Kong/slsa-github-generator/tree/main/internal/builders/maven) to build Java projects and publish to Maven central.

### v1.9.0: Gradle builder (beta)

- **New**: A [Gradle builder](https://github.com/Kong/slsa-github-generator/tree/main/internal/builders/gradle) to build Java projects and publish to Maven central.
...
See the [full change list](https://github.com/Kong/slsa-github-generator/compare/v1.7.0...v1.8.0).

### v1.8.0: Generic Generator

- **Added**: A new
  [`base64-subjects-as-file`](https://github.com/Kong/slsa-github-generator/blob/v1.8.0/internal/builders/generic/README.md#workflow-inputs)
...
- **Fixed**: Publishing for non-scoped packages was fixed (See
  [#2359](https://github.com/Kong/slsa-github-generator/issues/2359))
...
[Container-based builder](https://github.com/Kong/slsa-github-generator/tree/v1.7.0/internal/builders/docker).
...
- **Added**: A new
  [go-version-file](https://github.com/Kong/slsa-github-generator/blob/main/internal/builders/go/README.md#workflow-inputs)
...
This release includes the first beta release of the
[Node.js builder](https://github.com/Kong/slsa-github-generator/tree/v1.6.0/internal/builders/nodejs).
...
- A new
  [`prerelease`](https://github.com/Kong/slsa-github-generator/blob/v1.6.0/internal/builders/go/README.md#workflow-inputs)
  input was added to allow users to create releases marked as prerelease when
  `upload-assets` is set to `true`.
- A new input [`draft-release`](https://github.com/Kong/slsa-github-generator/blob/v1.6.0/internal/builders/go/README.md#workflow-inputs) was added to allow users to create releases marked
  as draft when `upload-assets` is set to `true`.
- A new output [`go-provenance-name`](https://github.com/Kong/slsa-github-generator/blob/v1.6.0/internal/builders/go/README.md#workflow-outputs) added which can be used to retrieve the name
...
- A new input [`draft-release`](https://github.com/Kong/slsa-github-generator/blob/v1.6.0/internal/builders/generic/README.md#workflow-inputs) was added to allow users to create releases marked
  as draft when `upload-assets` is set to `true`.
...
https://github.com/Kong/slsa-github-generator/compare/v1.5.0...v1.6.0
...
- A new [`upload-tag-name`](https://github.com/Kong/slsa-github-generator/blob/v1.5.0/internal/builders/generic/README.md#workflow-inputs) input was added to allow users to specify the tag name for the release when `upload-assets` is set to `true`.
- The environment variables included in provenance output were changed to include only those variables that are specified by the user in the [slsa-goreleaser.yml configuration file](https://github.com/Kong/slsa-github-generator/tree/v1.5.0/internal/builders/go#configuration-file) in order to improve reproducibility. See [#822](https://github.com/Kong/slsa-github-generator/issues/822) for more information and background.

#### Generic generator

##### New Features

- A new boolean [`continue-on-error`](https://github.com/Kong/slsa-github-generator/blob/v1.5.0/internal/builders/generic/README.md#workflow-inputs) input was added which, when set to `true`, prevents the workflow from failing when a step fails. If set to true, the result of the reusable workflow will be return in the [`outcome`](https://github.com/Kong/slsa-github-generator/blob/v1.5.0/internal/builders/generic/README.md#workflow-outputs) output.
- A new [`upload-tag-name`](https://github.com/Kong/slsa-github-generator/blob/v1.5.0/internal/builders/generic/README.md#workflow-inputs) input was added to allow users to specify the tag name for the release when `upload-assets` is set to `true`.
...
1. Allow users of the [Generic Generator](https://github.com/Kong/slsa-github-generator/tree/main/internal/builders/generic) to generate provenance for artifacts created in a project subdirectory (#1225)

#### Go Builder

##### Bug fixes

1. Allow environment variables to contain '=' characters in the [Go builder](https://github.com/Kong/slsa-github-generator/tree/main/internal/builders/go) (#1231)

### New Contributors

- @cfergeau made their first contribution in https://github.com/Kong/slsa-github-generator/pull/1232
- @DanAlbert made their first contribution in https://github.com/Kong/slsa-github-generator/pull/1239
- @gal-legit made their first contribution in https://github.com/Kong/slsa-github-generator/pull/1252

### Full Changelog

https://github.com/Kong/slsa-github-generator/compare/v1.2.2...v1.4.0
...
This release is the first Generally Available version of the [generic container workflow](https://github.com/Kong/slsa-github-generator/tree/main/internal/builders/container). The generic container workflow is now considered stable and can be included in your production GitHub Actions workflows
...
1. Allow users of the [generic generator workflow](https://github.com/Kong/slsa-github-generator/tree/main/internal/builders/generic) to generate provenance using for artifacts created in a project subdirectory (#1225)
2. Allow environment variables to contain '=' characters in the [Go workflow](https://github.com/Kong/slsa-github-generator/tree/main/internal/builders/go) (#1231)
...
https://github.com/Kong/slsa-github-generator/compare/v1.2.2...v1.4.0-rc.2
...
https://github.com/Kong/slsa-github-generator/compare/v1.2.2...v1.4.0-rc.1
...
https://github.com/Kong/slsa-github-generator/compare/v1.2.2...v1.4.0-rc.0
...
- @suzuki-shunsuke made their first contribution in https://github.com/Kong/slsa-github-generator/pull/1061
- @datosh made their first contribution in https://github.com/Kong/slsa-github-generator/pull/1074
- @pnacht made their first contribution in https://github.com/Kong/slsa-github-generator/pull/1187
- @dongheelee92 made their first contribution in https://github.com/Kong/slsa-github-generator/pull/1209

### Full Changelog

https://github.com/Kong/slsa-github-generator/compare/v1.2.1...v1.2.2

## v1.2.1

**DO NOT USE THIS RELEASE. This version will no longer work and is not supported due to errors described in #1163. Please upgrade to [v1.2.2](https://github.com/Kong/slsa-github-generator/releases/tag/v1.2.2) or later.**
...
```json
"buildType": "https://github.com/Kong/slsa-github-generator@v1",
```

The new value is:

```json
"buildType": "https://github.com/Kong/slsa-github-generator/generic@v1",
```
...
- @sethmlarson made their first contribution in https://github.com/Kong/slsa-github-generator/pull/758
- @yunginnanet made their first contribution in https://github.com/Kong/slsa-github-generator/pull/776
- @diogoteles08 made their first contribution in https://github.com/Kong/slsa-github-generator/pull/957

### Full Changelog

https://github.com/Kong/slsa-github-generator/compare/v1.2.0...v1.2.1

## v1.2.0

**DO NOT USE THIS RELEASE. This version will no longer work and is not supported due to errors described in #942. Please upgrade to [v1.2.2](https://github.com/Kong/slsa-github-generator/releases/tag/v1.2.2) or later.**

### What's Changed

#### Generic generator

The highlight of this release is a new re-usable workflow called the "Generic generator". It lets users build artifacts on their own and generate a provenance that satisfies SLSA provenance 3 requirement. It's perfect to get started with SLSA with minimal changes to an existing build workflow. To use it, check the [README.md](https://github.com/Kong/slsa-github-generator/blob/main/internal/builders/generic/README.md)!
...
- @naveensrinivasan made their first contribution in https://github.com/Kong/slsa-github-generator/pull/352
- @renovate-bot made their first contribution in https://github.com/Kong/slsa-github-generator/pull/401
- @rarkins made their first contribution in https://github.com/Kong/slsa-github-generator/pull/489
- @developer-guy made their first contribution in https://github.com/Kong/slsa-github-generator/pull/497
- @loosebazooka made their first contribution in https://github.com/Kong/slsa-github-generator/pull/573

### Full Changelog

https://github.com/Kong/slsa-github-generator/compare/v1.1.1...v1.2.0
...
- @joshuagl made their first contribution in https://github.com/Kong/slsa-github-generator/pull/199
- @mihaimaruseac made their first contribution in https://github.com/Kong/slsa-github-generator/pull/202
- @MarkLodato made their first contribution in https://github.com/Kong/slsa-github-generator/pull/312
- @chipzoller made their first contribution in https://github.com/Kong/slsa-github-generator/pull/354

### Full Changelog

https://github.com/Kong/slsa-github-generator/compare/v1.0.0...v1.1.1
...
To learn how to use it, see [./README.md#golang-projects](https://github.com/Kong/slsa-github-generator#golang-projects)

### Contributors

@asraa @ianlewis @MarkLodato @joshuagl @laurentsimon

[v1.8.0]: https://github.com/Kong/slsa-github-generator/releases/tag/v1.8.0
[v1.9.0]: https://github.com/Kong/slsa-github-generator/releases/tag/v1.9.0
