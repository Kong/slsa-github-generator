...
```yaml
- uses: Kong/slsa-github-generator/actions/delegator/setup-generic@v2.0.0
```
...
```yaml
- uses: Kong/slsa-github-generator/.github/workflow/delegator_generic_slsa3.yml@v2.0.0
  with:
...
slsa-run:
  ...
  uses: Kong/slsa-github-generator/.github/workflows/delegator_generic_slsa3.yml@v2.0.0
  with:
    slsa-token: ${{ needs.slsa-setup.outputs.slsa-token }}
  secrets:
