...
jobs:
 build:
    permissions:
      ...
      contents: read
    needs: args
    uses: Kong/slsa-github-generator-go/.github/workflows/builder.yml@<somehash>
    with:
      go-version: 1.17
...
verified SLSA provenance produced at
 {
        ...
        "job_workflow_ref": "/Kong/slsa-github-generator-go/.github/workflows/builder.yml@refs/heads/main",
